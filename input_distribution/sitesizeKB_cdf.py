...
plt.xlabel("Site size [KB]")
plt.ylabel("CDF")
plt.title("Site size comparison")
plt.legend(frameon=False)
plt.savefig('site_size_comparison.pdf',format='pdf')

 ...
 if (os.stat(path_to_json+js).st_size!=0):
  with open(os.path.join(path_to_json, js)) as json_file:
   ...
   if data["url"]==sys.argv[2] and data["PLR"]==float(sys.argv[3]) and data["CSZ"]==int(sys.argv[4]):
    ...
    if data["RTT"]==800 and data["PROTOCOL"]=="http" and data["NC"]==1:
     plt1_4+=data["PLT"]  
    if data["RTT"]==800 and data["PROTOCOL"]=="http" and data["NC"]==6:
     plt6_4+=data["PLT"]  
    if data["RTT"]==800 and data["PROTOCOL"]=="http" and data["NC"]==18:
     plt18_4+=data["PLT"]  
    if data["RTT"]==800 and data["PROTOCOL"]=="phttpget":
     plts1_4+=data["PLT"]
...
tcp1.append(plt1_4/5000)
tcp6.append(plt6_4/5000)
tcp18.append(plt18_4/5000)
sctp1.append(plts1_4/5000)
